			...
			<view class="content" style="">
				...
				<view class="list" style="">
					<view class="item"  style="" @click="todevice">
						<view class="item-left" style="" >
							<image class="left-img" src="https://www.yp10000.com/static/img/hos/14.png" mode="" style=""></image>
					...
					<view class="item"  style="" @click="Toitem()">
						<view class="item-left" style="">
							<image class="left-img" src="https://www.yp10000.com/static/img/hos/35.png" mode="" style=""></image>
					...
					<view class="item"  style="" @click="">
						<view class="item-left" style="">
							<image class="left-img" src="https://www.yp10000.com/static/img/hos/36.png" mode="" style=""></image>
				...
				<view class="proportion" style="">
						<view class="proportion-left" style="">
							<image src="https://www.yp10000.com/static/img/hos/3.png" mode="" style=""></image>
...
<style scoped lang="less">
	...
	.container{
		height: 100vh;width: 100%;background-color: #fff;
		.main{
