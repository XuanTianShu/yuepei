<template>
	<view class="container" style="">
		...
		<view class="content" >
			...
			<view class="" style="">
				<text style="">{{effectiveOrder}}</text>
...
<script>
	import {selectAgentRevenueStatistics} from '@/api/system/agent'
	export default{
		data(){
			return{
				dispayType:2,
...
<style lang="less" scoped>
	.container{
		...
		.content{
			margin-top: 40rpx;
			background:url('https://www.yp10000.com/static/img/agent/25.png');
			  background-size:100% 100%;
			  background-repeat:no-repeat;
			// background-image: linear-gradient(to right , #fff3dc,#ffebc3,#ffeac4);
